...
processed_a = cv2.GaussianBlur(original,(11,11),0)
processed_b = cv2.GaussianBlur(original,(17,17),0)
processed_c = cv2.GaussianBlur(original,(25,25),0)
processed_d = cv2.GaussianBlur(original,(55,55),0)
processed_e = cv2.GaussianBlur(original,(75,75),0)

#processed_best = cv2.blur(full_original, (50,50))
...
os.chdir("G:\\My Drive\\High School\\Grade 12\\Math Stats\\Math IA\\Code and resources\\Guassian_blur") 
cv2.imwrite("guass_strip.png", canvas)
