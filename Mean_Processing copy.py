...
processed_a = cv2.blur(original, (11,11))
processed_b = cv2.blur(original, (17,17))
processed_c = cv2.blur(original, (25,25))
processed_d = cv2.blur(original, (55,55))
processed_e = cv2.blur(original, (75,75))
...
os.chdir("G:\My Drive\High School\Grade 12\Math Stats\Math IA\Code and resources\Mean_processed") 
cv2.imwrite("mean_strip.png", canvas)
